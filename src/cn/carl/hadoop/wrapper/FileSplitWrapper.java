...
public class FileSplitWrapper implements ClassMaker {
    ...
    static {
        //获取当前要改造的类的CtClass对象
        CtClass ctClass = AssistTools.getCtClassByName(HADOOP_FILE_SPLIT_CLASS);
    ...
    private static void addConstructor(CtClass ctClass) {
        ...
        CtClass[] param = new CtClass[]{
                AssistTools.getCtClassByName("[Ljava.lang.String;")};

        //添加构造器
        AssistTools.addConstructor(body, param, ctClass);
    }
    ...
    private static void addMethods(CtClass ctClass) {
        ...
        try {
            ...
            //获取调用的方法
            CtMethod getPathMethod = AssistTools.getMethod(ctClass, methodName, null);
